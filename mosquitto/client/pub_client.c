...
int main(int argc, char *argv[])
{
  ...
  ///// Add for TLS-PS /////
  fprintf(stderr, "before set the role\n");
  mosquitto_role_set(mosq, CLIENT_PUB);
  fprintf(stderr, "before set the topic: %s\n", cfg.topic);
  mosquitto_topic_set(mosq, cfg.topic, strlen(cfg.topic));
  //////////////////////////
